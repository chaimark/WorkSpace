...
typedef struct{
   void (*lpByteWritefunc_1)(unsigned char src);
   unsigned char (*lpByteReadfunc_1)();
   void (*lpSwitchEnStatus_1)(cmdEntype_t cmd);
   void (*paSwitchCmdfunc_1)(cmdpaType_t cmd);
   void (*lpRecvDataTousr_1)(unsigned char *lpbuf,unsigned short length);
}lpCtrlTypefunc_t_1;
...
void SX1276LoRaSetPacketCrcOn_1(BOOL enable);
