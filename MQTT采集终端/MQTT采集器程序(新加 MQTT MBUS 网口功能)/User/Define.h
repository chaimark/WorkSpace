...
#define FLASH_RST_HIGH FL_GPIO_SetOutputPin(GPIOC, FL_GPIO_PIN_8)
#define FLASH_RST_LOW FL_GPIO_ResetOutputPin(GPIOC, FL_GPIO_PIN_8)

#define FLASH_SSN_HIGH FL_GPIO_SetOutputPin(GPIOC, FL_GPIO_PIN_9)
#define FLASH_SSN_LOW FL_GPIO_ResetOutputPin(GPIOC, FL_GPIO_PIN_9)

#define FLASH_SCLK_HIGH FL_GPIO_SetOutputPin(GPIOC, FL_GPIO_PIN_7)
#define FLASH_SCLK_LOW FL_GPIO_ResetOutputPin(GPIOC, FL_GPIO_PIN_7)

#define FLASH_MOSI_HIGH FL_GPIO_SetOutputPin(GPIOC, FL_GPIO_PIN_6)
#define FLASH_MOSI_LOW FL_GPIO_ResetOutputPin(GPIOC, FL_GPIO_PIN_6)

#define FLASH_SDA_VALUE (FL_GPIO_ReadInputPort(GPIOC) & FL_GPIO_PIN_5)
...
#define EC20_RST_ON() FL_GPIO_SetOutputPin(GPIOB, FL_GPIO_PIN_7) // > 300ms
...
//#define NET_CFG_ON FL_GPIO_SetOutputPin(GPIOA, FL_GPIO_PIN_7) // PA7
//#define NET_CFG_OFF FL_GPIO_ResetOutputPin(GPIOA, FL_GPIO_PIN_7)
// LED显示
...
#define RS485_LED_H FL_GPIO_SetOutputPin(GPIOD, FL_GPIO_PIN_11) // PD11
#define RS485_LED_L FL_GPIO_ResetOutputPin(GPIOD, FL_GPIO_PIN_11)
...
// 电源   控制AO3401用此程序
#define VBAT_29302_CTL_ON FL_GPIO_ResetOutputPin(GPIOA, FL_GPIO_PIN_9)
#define VBAT_29302_CTL_OFF FL_GPIO_SetOutputPin(GPIOA, FL_GPIO_PIN_9) // PA9

// 网口老版本  控制器BL1551用此程序    控制用AO3401用此程序
...
#define EEprom_SDA_HIGH FL_GPIO_SetOutputPin(GPIOB, FL_GPIO_PIN_9)
...
#define EEprom_SCL_HIGH FL_GPIO_SetOutputPin(GPIOB, FL_GPIO_PIN_8)
#define EEprom_SCL_LOW FL_GPIO_ResetOutputPin(GPIOB, FL_GPIO_PIN_8)

#define RX8025T_SDA_HIGH FL_GPIO_SetOutputPin(GPIOD, FL_GPIO_PIN_6)
...
#define RX8025T_SCL_HIGH FL_GPIO_SetOutputPin(GPIOD, FL_GPIO_PIN_5)
...
#define Select_ON_CH340_To_LPUART1 FL_GPIO_SetOutputPin(GPIOB, FL_GPIO_PIN_4) // PB4    LUART1_TO_USB
...
#define Select_ON_CH340_To_RS4851 FL_GPIO_SetOutputPin(GPIOB, FL_GPIO_PIN_0) // PB0    RS4851_TO_USB
#define Select_OFF_CH340_To_RS4851 FL_GPIO_ResetOutputPin(GPIOB, FL_GPIO_PIN_0)

#define Select_ON_CH340_To_RS4852 FL_GPIO_SetOutputPin(GPIOA, FL_GPIO_PIN_11) // PA11  RS4852_TO_USB
#define Select_OFF_CH340_To_RS4852 FL_GPIO_ResetOutputPin(GPIOA, FL_GPIO_PIN_11)

// 选通开关
// PD4     EC20与UART0之间
// PA4     USART1与M-BUS电路  之间
// PA5     RS232与M-BUS电路  之间
#define MBUS_OUT_ON FL_GPIO_ResetOutputPin(GPIOC, FL_GPIO_PIN_10) // PC10
#define MBUS_OUT_OFF FL_GPIO_SetOutputPin(GPIOC, FL_GPIO_PIN_10)
#define MBUS_OUT_VALUE (FL_GPIO_ReadOutputPort(GPIOC) & FL_GPIO_PIN_10)
